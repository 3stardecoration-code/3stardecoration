...
export function AdminSidebar({ logoUrl }: { logoUrl?: string | null }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-72 flex-col border-r border-gray-200 bg-white transition-transform duration-300 lg:w-64 lg:translate-x-0 ${
...
// ---------------------------------------------------------------------------
// Icons (Inline SVGs to avoid dependency overhead for now)
// ---------------------------------------------------------------------------
...
function QuoteIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.017 6v6.031c0 2.25-1.406 3.5-3.5 3.938l-.5-1.031c1.125-.469 1.75-1.219 1.844-2.313H10V6h4.017zm7.983 0v6.031c0 2.25-1.406 3.5-3.5 3.938l-.5-1.031c1.125-.469 1.75-1.219 1.844-2.313H18V6h4z" />
    </svg>
  );
}
